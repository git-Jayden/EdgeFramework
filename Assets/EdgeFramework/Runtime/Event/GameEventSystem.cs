...
namespace EdgeFramework
{
    ...
    public class GameEventSystem : Singleton<GameEventSystem>,IPoolable
    {
        /// <summary>
        /// 缓存所有的事件 
        /// </summary>
        ...
        private class ListenerWrap
        {
            ...
            {
                if (mEventList==null||mEventList.Count<=0) return false;
            ...
            {
                if (mEventList == null || mEventList.Count <= 0) return;
                if (mEventList.Contains(listener))
