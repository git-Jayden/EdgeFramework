...
namespace EdgeFrameworkEditor
{
    public class DataEditor 
    {
        ...
        [MenuItem(Constants.ProductName + "/" + Constants.DataConversion +"/所有Xml转Binary")]
        ...
        [MenuItem(Constants.ProductName + "/" + Constants.DataConversion + "/Excel转Xml")]
        ...
        //    }
        //}
        //[MenuItem("Ls_Mobile/测试/测试写入Excel")]
        ...
        //    }
        //}
        //[MenuItem("Ls_Mobile/测试/测试已有类进行反射")]
        ...
        //    }
        //}
        //[MenuItem("Ls_Mobile/测试/测试已有数据进行反射")]
        ...
        private static void ExcelToXml(string name)
        {
            ...
            SerializeHelper.SerializeXML(XmlPath + xmlName, objClass);
        ...
        private static object GetObjFormXml(string name)
        {
            ...
            if (type != null)
            {
                ...
                return SerializeHelper.DeserializeXML(xmlPath, type);
        ...
        private static void XmlToBinary(string name)
        {
            ...
            try
            {
                ...
                if (type != null)
                {
                    ...
                    object obj = SerializeHelper.DeserializeXML(xmlPath, type);
                    SerializeHelper.SerializeBinary(binaryPath, obj);
        ...
        private static void ClassToXml(string name)
        {
            ...
            try
            {
                ...
                if (type != null)
                {
                    ...
                    string xmlPath = XmlPath + name + ".xml";
                    SerializeHelper.SerializeXML(xmlPath, temp);
