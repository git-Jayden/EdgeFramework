...
namespace EdgeFramework
{
    ...
    public class DoubleLinkedList<T> where T : class, new()
    {
        ...
        //双向链表结构类对象池
        protected SimpleObjectPool<DoubleLinkedListNode<T>> m_DoubleLinkNodePool = new SimpleObjectPool<DoubleLinkedListNode<T>>(()=>{ return new DoubleLinkedListNode<T>(); },initCount:500);
        //个数
