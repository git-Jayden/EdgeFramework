...
namespace Ls_Mobile
{
    ...
    public static class GameObjectExtension
    {
        ...
        #endregion
        #region CEGO005 DestroyGameObjAfterDelay
    ...
    public static class GraphicExtension
    {
        public static void Example()
        {
            ...
            var rawImage = gameObject.GetOrAddComponent<RawImage>();
    ...
    public static class ImageExtension
    {
        ...
        {
            var gameObject = new GameObject();
            var image1 = gameObject.GetOrAddComponent<Image>();
    ...
    public static class ObjectExtension
    {
        ...
        /// <summary>
        /// return self after Destroy Self
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="selfObj"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// return self after Delay Destroy Self
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="selfObj"></param>
        ...
        /// <summary>
        /// return self after Executive function
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="selfObj"></param>
        /// <param name="toFunction"></param>
        /// <returns></returns>
    ...
    public static class RectTransformExtension
    {
        ...
        public static RectTransform SetAnchorPosX(this RectTransform selfRectTrans, float anchorPosX)
        {
        ...
        public static RectTransform SetAnchorPosY(this RectTransform selfRectTrans, float anchorPosY)
        {
            var anchorPos = selfRectTrans.anchoredPosition;
    ...
    public static class TransformExtension
    {
        ...
        /// <summary>
        /// Find the Transform you specified below 
        /// </summary>
        ...
        public static void SetTransform(this Transform selfTrans, Transform fromTrans)
        {
