...
{
    unsafe class CRLBindingTestClass_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::CRLBindingTestClass);
        ...
        static StackObject* DoSomeTest_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = global::CRLBindingTestClass.DoSomeTest(@a, @b);
